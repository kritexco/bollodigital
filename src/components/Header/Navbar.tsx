...
import { slideUp, fadeOut, slideToggle } from "@utils/animation";
...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { to: "/portfolio", label: "B2B Services" },
    { to: "/D2D", label: "D2C Services" },
  ...
  return (
    <React.Fragment>
      <Bar expand="lg" className={`${scrolled ? "scrolled" : ""}`}>
        <Container>
          <Bar.Brand href="/">
            <Image src="/8.png" alt="Brand Logo" className="img-fluid" width="220" height="95" />
          </Bar.Brand>
          <button
